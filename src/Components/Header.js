...
const Header = () => {
  ...
  className=" hidden  text-white w-full overflow-hidden transition-all duration-300 absolute z-[1] h-[200vh] bg-[#0000004f]"
>
  {/* Slider Navigation */}
  <div className="bg-[#081736]">
    <div className="flex items-center lg:w-[1000px] w-full mx-auto">
      ...
      <div
        id="drop-slider"
        className="flex gap-4 overflow-hidden scroll-smooth mx-[25px]"
      >
        <Link href="/t20series">
          <div className="flex-shrink-0 w-[150px] flex items-center flex-col">
            <img
