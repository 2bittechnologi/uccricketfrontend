                    ...
                    <div class="lg:col-span-8 md:col-span-7">
                        ...
                        <div class="tab-section">
                            ...
                            <div class="tab-content-container">
                                ...
                                <div id="fantasytips2" className={`tab-content ${activeTab === 'fantasytips2' ? '' : 'hidden'}`}>Hello from Section 2</div>
                                <div id="ipl2" className={`tab-content ${activeTab === 'ipl2' ? '' : 'hidden'}`}>Live Content 2</div>
                                <div id="dailyquiz2" className={`tab-content ${activeTab === 'dailyquiz2' ? '' : 'hidden'}`}>Scorecard 2</div>
                                <div id="pointstable2" className={`tab-content ${activeTab === 'pointstable2' ? '' : 'hidden'}`}>xcjkl 2</div>
                                <div id="socialtrends2" className={`tab-content ${activeTab === 'socialtrends2' ? '' : 'hidden'}`}>Scorecard ghj</div>
